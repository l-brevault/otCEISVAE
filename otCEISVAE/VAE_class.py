...
def create_encoder_VAE(encoder,input_dim,latent_dim):
...
def create_decoder_VAE(decoder,input_dim,latent_dim):
...
class VAE(keras.Model):
    def __init__(self, encoder, decoder, vp_layer, input_dim, latent_dim, K, mean_x, std_x, **kwargs):
        ...
        self.K = K
        self.encoder = create_encoder_VAE(encoder,input_dim,latent_dim)
        self.decoder = create_decoder_VAE(decoder,input_dim,latent_dim)
