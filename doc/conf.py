# -*- coding: utf-8 -*-
#
# otCEISVAE documentation build configuration file, created by
...
intersphinx_mapping = {
    "python": ("http://openturns.github.io/openturns/latest", "openturns-objects.inv")
}
...
# htmlhelp_basename = 'otCEISVAEdoc'
